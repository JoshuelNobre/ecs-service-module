...
resource "aws_cloudwatch_metric_alarm" "cpu_high" {
  ...
  alarm_description = "Alarme de CPU alta para escalar o serviço ${var.service_name} no cluster ${var.cluster_name}"
...
resource "aws_appautoscaling_policy" "cpu_low" {
  ...
  step_scaling_policy_configuration {
    ...
    step_adjustment {
      ...
      scaling_adjustment          = var.scale_in_adjustment * 2
    }
  }
}
...
resource "aws_cloudwatch_metric_alarm" "cpu_low" {
  ...
  alarm_description = "Alarme de CPU baixa para escalar o serviço ${var.service_name} no cluster ${var.cluster_name}"
